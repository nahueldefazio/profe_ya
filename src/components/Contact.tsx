    ...
    <section id="contacto" className="contact section">
      <div className="container">
        ...
        <p className="section-subtitle">
          ¿Listo para comenzar tu aprendizaje? Contáctame ahora mismo
        </p>
        ...
        <div className="contact-content">
          ...
          <div className="whatsapp-section">
            ...
            <p className="whatsapp-description">
              La forma más rápida y directa de contactarme. Resuelvo tus dudas al instante.
            </p>
            
            <a 
              href="https://wa.me/15551234567?text=Hola!%20Me%20interesa%20recibir%20clases%20particulares" 
            ...
            >
              ...
              <div className="whatsapp-text">
                <span className="whatsapp-title">Enviar WhatsApp</span>
